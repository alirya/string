...
export default function EmptyParameter<MessageType>(
    message : Static.Parameter<string, '', string, false, true, MessageType>
) : Validator<string, '', Readonly<Instance<'', MessageType>>>;

export default function EmptyParameter<MessageType>(
    message : Static.Parameter<string, '', string, false, true, MessageType|string>= EmptyString.Parameter
) : Validator<string, '', Readonly<Instance<'', MessageType>>> {
