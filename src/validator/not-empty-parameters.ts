...
export default function NotEmptyParameters<MessageType>(
    message : FunctionStatic.Parameters<string, '', string, false, true, MessageType>
) : Validator<string, '', true, false, Readonly<Instance<string, MessageType>>>;

export default function NotEmptyParameters<MessageType>(
    message : FunctionStatic.Parameters<string, '', string, false, true, MessageType|string> = NotEmptyString.Parameters
) : Validator<string, '', true, false, Readonly<Instance<string, MessageType>>> {
