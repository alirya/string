...
export default function EmptyParameters<MessageType>(
    message : Static.Parameters<string, '', string, false, true, MessageType>
) : Validator<string, '', Readonly<Instance<'', MessageType>>>;

export default function EmptyParameters<MessageType>(
    message : Static.Parameters<string, '', string, false, true, MessageType|string> = EmptyString.Parameters
) : Validator<string, '', Readonly<Instance<'', MessageType>>> {
