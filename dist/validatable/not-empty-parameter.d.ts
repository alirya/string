...
export declare type NotEmptyArgument<ValueType extends string, MessageType> = Message<FunctionStatic.Parameter<string, '', ValueType, false, true, MessageType>> & Value<ValueType>;
export { NotEmptyType };
